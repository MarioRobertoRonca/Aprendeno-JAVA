...
public class TelaEquacao extends javax.swing.JFrame {
    ...
    private void txtCStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_txtCStateChanged
        // Modificar o testo da label C
        lblC.setText(txtC.getValue().toString());
    }//GEN-LAST:event_txtCStateChanged

    private void btnCalcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcActionPerformed
        // Comandos do botão calcular
        // Comando Para aparecer o painel
        panResultado.setVisible(true);
        //Comandos para buscar variáveis das caixas de texto
        int a = Integer.parseInt(txtA.getValue().toString());
        int b = Integer.parseInt(txtB.getValue().toString());
        int c = Integer.parseInt(txtC.getValue().toString());
        // Calculo do Delta 
        double d = Math.pow(b, 2) - 4*a*c;
        //Mostrar o delta na tela 
        lblDelta.setText(String.format("%.1f",d));
        //Calculo de baskara
        if(d<0){
            lblRaiz.setText("Não exitem raizes");
        }else{
            lblRaiz.setText("Exitem raizes");
        }
